...
while($row=mysql_fetch_array($result,MYSQLI_NUM))
  {
                            ...
                            echo "<input type='text' name='encargadoedit' size='30' maxlength='100' value='". $row[3] . "' required />";
                            echo "<br />E-mail:";
                            echo "<br />";
                            echo "<input type='email' name='emailedit' size='30' maxlength='100' value='". $row[2] . "' required />";
                            echo "<br /> Direccion:";
                            echo " <br />  ";
                            echo "<input id='direccion' type='text' name='direccionedit' value='". $row[4] . "' required />";
                            echo "<br /> Codigo Postal:";
                            echo "<br />  ";
                            echo "<input id='cp' type='text' name='cpedit' value='". $row[5] . "' required />";
                            echo "<br />Telefono:";
                            echo "<br />";
                            echo "<input id='telefono' type='text' name='telefonoedit' value='". $row[6] . "' required  />";
                            echo "<br />Ciudad:";
                            echo "<br />  ";
                            echo "<input type='text' name='ciudadedit' size='30' maxlength='100' value='". $row[7] . "' required />";
                            echo "<br />Pais:";
                            echo "<br />";
                            echo "<input type='text' name='paisedit' size='30' maxlength='100' value='". $row[8] . "' required />";
                            echo "<br />Creado por:";
                            echo "<br />";
                            echo "<input type='text' name='creado' size='30' maxlength='100' value='". $row[9] ."' disabled required />";
                            echo "<br />Modificado por:";
                            echo "<br />";
                            echo "<input type='text' name='modificadoedit' size='30' maxlength='100' value='". $row[10] ."' disabled required />";
